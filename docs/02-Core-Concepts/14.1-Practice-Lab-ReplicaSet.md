...
⚡️ **Inspect Pods Controlled by a ReplicaSet**
...
⚡️ **Inspect ReplicaSet YAML (Full Manifest)**
```bash
...
⚡️ **Scaling a ReplicaSet by number of `--replicas`:**
...
⚡️ **Scaling a ReplicaSet based on the resource `label`:**
...
### 14.1.4 Delete Pod → Observe Re-creation
...
### 14.1.9 Convert ReplicaSet → Deployment
